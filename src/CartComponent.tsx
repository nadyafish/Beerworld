...
export function CartComponent() {
    ...
    return (
        <Container>
            <div className={'add-to-cart red'}><Button variant="danger" onClick={() => clearAll()}>Очистить корзину</Button></div>
            <h5> </h5>
            {/*Полная цена*/}
            <h2>Сумма заказа: РУБ. {state.fullPrice}</h2>
            <h5> </h5>
            <Row>
            ...
            <h5> </h5>
            <div className="add-to-cart"><Button variant="success">Перейти к оплате</Button></div>
        </Container>
    );
}
